...
`data/packs.json` — แต่ละ pack ต้องมีคำ **อย่างน้อย 12 คำ** (เท่าจำนวนคนสูงสุด เพราะคนละคำไม่ซ้ำ)
คำใน pack ต้องอยู่ในธีมเดียวกันจนหาเรื่องคุยให้อีกฝ่ายเผลอพูดได้ ไม่จำกัดว่าต้องเป็นคำนาม — เป็นคำกริยาหรือคำอื่นก็ได้
ถ้า pack มีคำเกิน 12 ให้สุ่มหยิบเท่าจำนวนคน
...
3-4 คน → 5 นาที · 5-8 คน → 10 นาที · 9-12 คน → 15 นาที
